...
/*
  public void agregarComodidadesPersonalizadas(Asociacion model.asociacion,List<ComodidadIdeal> comodidadIdeals){
    this.comodidadesPersonalizadas.put(model.asociacion, comodidadIdeals);
  }*/
}
